  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'card-xl': '0 20px 25px -5px rgb(0 0 0 / 0.08), 0 8px 10px -6px rgb(0 0 0 / 0.05)',
        'glow-brand': '0 0 0 3px rgb(99 102 241 / 0.25)',
        'glow-rose':  '0 0 0 3px rgb(244 63 94 / 0.25)',
        'sidebar':    '2px 0 20px 0 rgb(0 0 0 / 0.15)',
      },
      backgroundImage: {
        ...
        'gradient-mesh':  'radial-gradient(at 40% 20%, hsla(228,97%,67%,0.2) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(189,100%,56%,0.1) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(355,100%,93%,0.1) 0px, transparent 50%)',
